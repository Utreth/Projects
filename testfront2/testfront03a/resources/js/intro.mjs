export default class Intro {
  ...
  constructor() {
    console.info('Revisa la implementación de la clase Intro')
  }
  ...
  // Observe dos expresiones a las que se le ha asignado casi lo mismo

  saludar = function (nombre = 'Carlos Cuesta') {
    console.log(`¡Hola, ${nombre}!`)
  }

  despedir = nombre => console.log(`Adios, ${nombre}!`)

  funcionesComoExpresiones() {
    ...
    amigos.forEach(Intro.saludar) // <--- referenciando la función
    // amigos.forEach(Intro.saludar()) // <--- llamando la función
    // amigos.forEach(Intro.saludar('Carlos')) // <--- llamando la función
  }
}
